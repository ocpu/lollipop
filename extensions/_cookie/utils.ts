...
export function setCookie(ctx: IncomingRequestContext, cookie: Cookie): Cookie
export function setCookie(ctx: IncomingRequestContext, key: string, value: string, options?: CookieAttributes): Cookie
